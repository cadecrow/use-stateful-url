(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.useStatefulUrl = {}, global.React));
    ...
    function useStatefulUrl(initialState, options = {}) {
        ...
        const resolvedDelimiters = react.useMemo(() => ({
        ...
        const memoizedSerializers = react.useMemo(() => {
        ...
        const updateHashCallback = react.useCallback((newState) => {
        ...
        const getHashWithoutState = react.useCallback(() => {
            return hashUtils.getHashWithoutState(resolvedDelimiters);
        }, [resolvedDelimiters]);
        const getStateFromHash = react.useCallback(() => {
    ...
    exports.hashSerializers = hashSerializers;
    exports.hashUtils = hashUtils;
    exports.useStatefulUrl = useStatefulUrl;
    exports.useStatefulUrlArray = useStatefulUrlArray;
    exports.useStatefulUrlSet = useStatefulUrlSet;
    exports.useStatefulUrlString = useStatefulUrlString;

}));
//# sourceMappingURL=useStatefulUrl.umd.js.map
